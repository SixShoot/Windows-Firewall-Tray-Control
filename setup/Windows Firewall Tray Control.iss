...
; 18-05-2018
; ---------------------------------
; Windows Firewall Tray Control Setup
; ---------------------------------

[Setup]
#define AppName "Windows Firewall Tray Control"
#define OurVersion "1.0"
#define Author "Xan"
#define Website "http://xan105.com/"
#define DonationURL "https://xan105.com/donate"
#define VersionURL "https://download.xan105.com/fsetup/WindowsFirewallTrayControl/version.ini"
...
AppId={{0AF147C9-3AEE-4AF1-A58B-E8DE85110625}
AppName={#AppName}
AppVerName={#AppName}
...
OutputDir=output\
  OutputBaseFilename=Windows Firewall Tray Control
SolidCompression=no
...
[UninstallRun]
Filename: "{cmd}"; Parameters: "/c SCHTASKS /Delete /F /TN ""Windows Firewall Tray Control"""; WorkingDir: "{app}"; StatusMsg: "Finishing uninstallation ..."; Flags: runhidden waituntilterminated skipifdoesntexist
...
begin
  ...
  idpSetOption('UserAgent',      'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.80 Safari/537.36');
